...
Verlet::Verlet(LAMMPS *lmp, int narg, char **arg) :
  Integrate(lmp, narg, arg) {printf("stone, in Verlet constructor\n");}
...
void Verlet::run(int n)
{
  ...
  printf("\n\nstone, in Verlet::run, step number = %d\n",n);
  ...
  for (int i = 0; i < n; i++) {
    ...
    printf("\nstone, in Verlet::run,       step index: %d\n",i);
    ...
    // run_stone to compute the average force by fix_stone_Pimd
    if (modify->fix_stone != 0) {
      printf("stone,    Verlet::run, CALL run_stone!  fix_run_stone      = %d\n",modify->fix_run_stone);
      run_stone(1);
      modify->fix_run_stone = 0;
      printf("stone,    Verlet::run, EXIT run_stone!  fix_run_stone      = %d\n",modify->fix_run_stone);
    }
...
/*void Verlet::run_stone(int n=2)
{

    printf("stone, in Verlet::run_stone, step index: %d\n",i);
