  ...
  atomKK(nullptr), memoryKK(nullptr), python(nullptr), citeme(nullptr)
{
  ...
  } //stone end of if at 510 universe/world
  ...
  if (helpflag) {
    ...
    printf("stone, in LAMMPS constructor\n");
    create();
    post_create();
  }
