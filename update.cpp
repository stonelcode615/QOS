...
#undef MINIMIZE_CLASS
  ...
  printf("stone, in Update constructor, call Verlet\n");
  str = (char *) "verlet";
...
{
  printf("stone, in Update::create_integrate %s\n",arg[0]);
...
{
  printf("stone, in Update::new_integrate\n");
...
{
  printf("stone, in Update::template integrate_creator\n");
